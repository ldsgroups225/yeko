...
type DiscussionScreenNavigationProp = StackNavigationProp<RootStackParamList, 'ConversationDetail'>;
...
const DiscussionScreen: React.FC = () => {
    ...
    const mockData: Conversation[] = [
      {
        ...
        lastMessage: 'Nous devons discuter des retards fréquents de votre enfant.',
      ...
      },
      {
        ...
        lastMessage: "Votre enfant a été impliqué dans un incident aujourd'hui.",
          ...
          >
            <CsText
              style={[
                ...
                selectedFilter === filter && themedStyles.selectedFilterButtonText,
              ]}
            >
              {filter === 'all'
                ? 'Tous'
  ...
  return (
    <View style={themedStyles.container}>
      ...
      />
      <TouchableOpacity style={themedStyles.newConversationButton} onPress={handleNewConversation}>
      ...
      {isNewConversationModalVisible && (
        <>
          <Animated.View
            style={[themedStyles.modalBackground, { opacity: modalBackgroundOpacity }]}
          />
          ...
          <View style={themedStyles.conversationHeader}>
            ...
            {conversation.unreadCount > 0 && (
              <View style={themedStyles.unreadBadge}>
                <CsText style={themedStyles.unreadBadgeText}>{conversation.unreadCount}</CsText>
              </View>
            )}
          </View>
          <CsText variant="body" numberOfLines={2} style={themedStyles.lastMessage}>
